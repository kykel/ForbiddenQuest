...
def turn():
    direction = input("Which way do you wish to go?\n1. left\n2. straight\n3. right\n4. go back")
    return direction
...
def main():
    ...
    answer = input("Fine! I needs a skeleton key. Can you get it for me?\nI'll pay you with some armor.\n")
    if answer == 'yes':
...
def specialquests():
    ...
    condition = input("Will you accept the offer?")
...
def skeletonkey():
    ...
    def graveyard():
        ...
        def gatedgraveyard():
            ...
            print("||                 |XXXXXX|                ||  ")                         
            print("||                 |XXXXXX|                ||   ")
            condition = input("Will you open it?\n")
            if condition == 'yes':
    ...
    def gravekeeper():
        ...
        condition = input("Nobody answers. You can hear no movement inside. Do you want to break open the window and climb inside?\n")
        if condition == 'yes':
    ...
    def moseleum():
        ...
        condition = input("Will you enter anyway?\n")
        if condition == 'yes':
            ...
            condition = input("But you quit believing in such mumbo jumbo years ago. Will you open the coffin?\n")
            if condition == 'yes':
    ...
    def mansion():
        ...
        def library():
            ...
            def toatriary():
                ...
                choice = input("There is no significant markings on the door. Do you wish to go through?")
...
#                    Initiate boss battle with Cave_Ghoul
            ...
            choice = input("Do you wish to search the library?")
            if choice == '1' or choice == 'yes' or choice.lower == 'yes':
        ...
        def singlemosuleaum():
            ...
            while i == 1:
                ...
                if choice == '1':
                    ...
                    if items.key == '1':
                        choice1 = input("The door opens. Enter?\n(yes or no)\n")
                        if choice1 == 'yes':
                            i = 0
                            entermosuleaum()
                        else:
