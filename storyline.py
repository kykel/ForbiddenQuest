...
def newgame():
    ...
    time.sleep(2)
    print(
        "You've parted company with the king, ten of his most trusted knights joining you on your quest. You contemplate the lucidity of your decision a moment but then push it aside.\nHow hard could it be to kill a dragon after all.\n")
    print(
        "The men follow you down, decked in armor and you realize that you have little to fight with. Luckily, the king well equipped you with treasure for your quest. Surely you can afford something.\n")
