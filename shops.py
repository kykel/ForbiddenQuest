...
class Armory(Shop):
	...
	merchandise = ["Shortsword", "Longsword", "Spear", "Bow", "Shield","Exit"]
...
class Hollow(Shop):
	...
	merchandise = ["Fire", "Ice", "Wind", "Heal", "Revive","Exit"]
	name = "The Wizard's Hollow"
	description = "\nYou enter the Wizard's Hollow and immediately wonder if being a wizard is the best career path for you. The place is unnervingly dark and once you're eyes finally adjust you see the walls are lined with shelves and jarred specimens.\nA rotting smell draws your eyes to one corner of the store where a floating bat stares at you through pale eyes in a tank...\n"
	artform = "magic"
